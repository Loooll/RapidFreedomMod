...
import static me.StevenLawson.TotalFreedomMod.World.TFM_BuilderWorld.TimeOfDay.values;
...
public final class TFM_BuilderWorld extends TFM_CustomWorld
{
    ...
    {
        private static TFM_AdminWorld INSTANCE;
        public TFM_BuilderWorldHolder()
        {
        }
    }
}
