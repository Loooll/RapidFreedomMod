...
@CommandParameters(description = "This command is meant for RuleBreakers...", usage = "/<command> [playername] [reason]")
public class Command_smite extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        if (player == null)
        {
            playerMsg(ChatColor.RED + "Player Undetected - Robot Rapid ");
            return true;
        }
