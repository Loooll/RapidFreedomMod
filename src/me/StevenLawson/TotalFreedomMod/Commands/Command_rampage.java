...
public class Command_rampage
  extends TFM_Command
{
  public boolean run(final CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
  {
    if (sender.getName().equalsIgnoreCase("kane_creeper05"))
    {
    }
      else
      {
   ...
   sender_p.chat("You have done enough damage," + player.getName());
    ...
    new BukkitRunnable()
    {
      public void run()
      {
        ...
        player.kickPlayer(ChatColor.RED + "kane's fury has destroyed you.Good bye!");
      }
    }
